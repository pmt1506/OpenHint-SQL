...
1. Download `OpenHintSQLSetup-1.0.8.exe` from the [v1.0.8 release](https://github.com/pmt1506/OpenHint-SQL/releases/tag/v1.0.8).
2. Close SSMS.
...
This writes `dist\OpenHintSQLSetup-1.0.8.exe`.
